...
import { LayoutDashboard, Users, CalendarCheck, Archive, Settings, LogOut, User, TicketCheck } from 'lucide-react'
...
const modules = [
  {
    href: '/master',
    label: 'Master',
    description: 'Konfigurasi dan pengaturan platform',
    icon: Settings,
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {visible.map((mod) => (
            <button
              ...
              className="group flex h-48 flex-col items-center justify-center gap-4 rounded-2xl border border-blue-100 bg-white p-6 text-center shadow-sm transition-all hover:border-primary/40 hover:shadow-md hover:-translate-y-0.5 cursor-pointer"
            >
              <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-blue-50 ring-1 ring-blue-100 transition-colors group-hover:bg-blue-100">
