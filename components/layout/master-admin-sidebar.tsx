...
const navItems: NavItem[] = [
  ...
  {
    href: '/master-admin/payment-methods',
    label: 'Metode Bayar',
    icon: Wallet,
...
export function MasterAdminSidebarNav({ onNavigate }: { onNavigate?: () => void }) {
